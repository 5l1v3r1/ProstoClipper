...
internal class <Module>
{
	...
	// Token: 0x06000002 RID: 2 RVA: 0x00003DAC File Offset: 0x00001FAC
	...
	// Token: 0x06000003 RID: 3 RVA: 0x00003E44 File Offset: 0x00002044
	...
	// Token: 0x06000005 RID: 5 RVA: 0x00003EBC File Offset: 0x000020BC
	...
	// Token: 0x06000023 RID: 35 RVA: 0x00004530 File Offset: 0x00002730
	internal unsafe static void smethod_31()
	{
		...
		uint num4 = 3471437935U;
		uint num5 = 3455371631U;
		uint num6 = 1340018457U;
		uint num7 = 642175690U;
		for (int i = 0; i < (int)num; i++)
		{
			uint num8 = *(ptr4++) * *(ptr4++);
			if (num8 != 2534544304U)
